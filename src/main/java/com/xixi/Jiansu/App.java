...
import com.xixi.Jiansu.spider.JiansuPipeline;
...
public class App 
{
    public static void main( String[] args )
    {
        ...
        String seedUser="http://www.jianshu.com/u/2b3ad4f2a058";//种子用户

       Spider.create(new JianShuProcessor(cookies)).addUrl(seedUser).addPipeline(new JiansuPipeline()).thread(3).run();
    }
}
